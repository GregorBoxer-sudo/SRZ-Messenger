...
<body>
    ...
    <p class = notFinishedYetText> We are currently working very hard on our Website, we try to finish it as soon as possible. <br>
    ...
    <div class = linkContainer>
        <a href="https://github.com/GregorBoxer-sudo/SRZ-Messenger" class = linkImages id = github><img src="https://1000logos.net/wp-content/uploads/2018/11/GitHub-logo-1024x925.png" width = "204" height = "184"></a>
        <a href="https://docs.google.com/document/d/1AW7I1kLx_LlGN_nbQE43joOdSn5mnM2fA2ZUST9VvsM/edit?usp=sharing" class=linkImages id = googleDocs><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Google_Docs_logo.svg/1200px-Google_Docs_logo.svg.png" width="120" height="166"></a>
    </div>
    </body>
</html>